...
const currentStudent = studentsData.filter(currentStudent => currentStudent._id === studentId)[0]

//  const currentStudent = studentsData.find((student) => student._id === studentId);
    ...
    <div className="StudentDetailsPage bg-gray-100 py-6 px-4 border-2 border-fuchsia-500 m-2">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md mb-6">
        {currentStudent && (
          <>
            <img
              src={currentStudent.image || placeholderImage}
              alt="profile-photo"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-24 mb-4 border-b pb-4">
              ...
              <p className="text-left mb-2 pb-2">
                <strong>Background:</strong> {currentStudent.background}
              </p>
